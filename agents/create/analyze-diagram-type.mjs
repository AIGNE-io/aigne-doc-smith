...
analyzeDiagramType.output_schema = {
  ...
  properties: {
    ...
    documentContent: {
      type: "string",
      description: "The full document content (kept for backward compatibility and additional context)",
    },
    documentSummary: {
      type: "string",
      description: "A concise summary of the document content focusing on key elements needed for diagram generation. This summary is generated by the analysis LLM to ensure consistent understanding between analysis and image generation models.",
    },
  },
  required: [
    "diagramType",
