...
afs 提供文件读取、写入、搜索的工具，你可以使用这些工具组合来完成任务：
- 读取文件列表 、或搜索文件确定用户希望编辑的文档
- 读取文档原始内容，分析用户希望做的修改
- 生成修改内容，更新文档
...
**重要提示:**此示例仅更新现有文档中的内容。如果用户要求"添加新的 API 文档页面",则应使用 create 工具。
