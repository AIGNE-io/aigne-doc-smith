...
本页面详细记录了 AIGNE DocSmith 每个版本的所有重要变更、新功能和错误修复。此处记录了从最新版本到初始版本的所有变更。
...
* 从 options.context 访问 Agent，而非加载新的 AIGNE 实例 ([#6](https://github.com/AIGNE-io/aigne-doc-smith/issues/6)) ([0e7ce1d](https://github.com/AIGNE-io/aigne-doc-smith/commit/0e7ce1d3889aab435b029a511cb7ebdbb213ab8a))
