...
当您的文档生成后，最后一步是将其发布到线上。本文档将提供一个分步指南，指导您如何使用 `aigne doc publish` 命令来发布文档，使其可供您的受众访问。

## 发布命令

`aigne doc publish` 命令会将您生成的文档文件上传到一个 Web 服务，让用户可以在 Web 浏览器中查看它们。为了提高效率，您可以使用主命令或其更短的别名。
